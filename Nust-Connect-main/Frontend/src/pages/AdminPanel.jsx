...
import { Users, FileText, Calendar, Trash2, Shield, Search } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-white flex items-center">
                <Shield className="mr-3 text-red-500" size={32} /> Admin Panel
            </h1>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 shadow-xl min-h-[500px]">
                ...
                {activeTab === 'events' && (
                    <div className="text-center py-20 text-slate-400">
                        ...
                        <h3 className="text-xl font-medium text-white">Event Approvals</h3>
                        <p>Pending event requests will typically be listed here for review.</p>
                    </div>
                )}
