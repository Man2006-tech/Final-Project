...
public class UserController {
    ...
    public ResponseEntity<UserResponseDTO> updateUser(
        ...
        System.out.println("Received update request for user " + userId + ": " + request);
        System.out.println("DOB: " + request.getDateOfBirth());
        System.out.println("Year: " + request.getYearOfStudy());
        ...
        if (request.getCmsId() != null)
            currentUser.setStudentId(request.getCmsId());
        ...
        try {
            ...
            if (profileChanged) {
                System.out.println("Profile changed. Updating...");
                profileService.updateProfile(userId, profile);
            } else {
                System.out.println("No profile changes detected.");
            }
        } catch (Exception e) {
    ...
    public ResponseEntity<ProfileResponseDTO> getProfile(@PathVariable Long userId) {
        ...
        if (profile == null) {
            // Return empty profile or 404. Given frontend expects data, return empty DTO or
            // create?
            // Profile.jsx handles empty fields. Let's return a default empty DTO.
            // But wait, profileId would be null.
            return ResponseEntity.ok(ProfileResponseDTO.builder().userId(userId).build());
        }
